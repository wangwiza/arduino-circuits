...
2. Clone the repo
   ```sh
   git clone https://github.com/wangwiza/arduino-circuits.git
   ```
...
See the [open issues](https://github.com/wangwiza/arduino-circuits/issues) for a full list of proposed features (and known issues).
